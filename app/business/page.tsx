  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-8 md:p-12 rounded-lg shadow-lg text-center">
        ...
        <p className="text-xl md:text-2xl mb-8 text-indigo-700 font-medium">Partner with ChaosStickers for Your Business Needs</p>

        <div className="max-w-3xl mx-auto text-left space-y-6 text-lg text-gray-800">
          <p>
            Unlock the power of custom stickers for your brand! At ChaosStickers, we're passionate about collaborating with businesses like yours. Whether you need eye-catching stickers for events, unique designs for resale, or custom creations for special projects, we're your dedicated partner.
          </p>
          <p>
